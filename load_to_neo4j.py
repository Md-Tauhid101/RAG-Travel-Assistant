...
def create_fulltext_index(tx):
    """
    Creates a full-text index on Entity nodes for `name` and `description`.
    This will be used by the hybrid RAG pipeline.
    """
    tx.run("""
    CREATE FULLTEXT INDEX entityFullTextIndex
    IF NOT EXISTS
    FOR (e:Entity)
